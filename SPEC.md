...
CREATE TABLE `base_albums` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `base_albums_slug_unique` (`slug`),
...
CREATE TABLE `photos` (
  ...
  `rating_avg` decimal(5,4) DEFAULT NULL,
  ...
  KEY `photos_rating_avg_index` (`rating_avg`),
  KEY `photos_album_id_is_highlighted_index` (`is_highlighted`),
  KEY `photos_album_id_is_highlighted_created_at_index` (`is_highlighted`,`created_at`),
  KEY `photos_album_id_is_highlighted_taken_at_index` (`is_highlighted`,`taken_at`),
  KEY `photos_album_id_is_highlighted_type_index` (`is_highlighted`,`type`),
  KEY `photos_is_highlighted_title_taken_created_index` (`is_highlighted`,`title`,`taken_at`,`created_at`),
